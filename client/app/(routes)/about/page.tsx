...
const About = () => {
	return (
		<div className="max-w-4xl mx-auto p-6">
			...
			<p className="text-lg text-gray-700 mb-4 text-justify dark:text-white">
			...
			<h2 className="text-2xl font-semibold text-gray-800 mb-2 dark:text-white">Notre mission</h2>
			...
			<h2 className="text-2xl font-semibold text-gray-800 mb-2 dark:text-white">Qui sommes-nous ?</h2>
