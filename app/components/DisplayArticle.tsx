import { DisplayArticleProps, Post } from "../types";
...
const DisplayArticle: React.FC<DisplayArticleProps> = ({ posts }) => {
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
			{posts.map((post: Post) => (
				<div key={post.id} className="border rounded-lg shadow-sm bg-white hover:shadow-md transition">						
					<div className="p-6">
						<h2 className="text-xl font-semibold text-gray-800 mb-2">{post.attributes.title}</h2>
